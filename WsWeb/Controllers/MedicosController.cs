...
namespace WsWeb.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeMedico,Especialidade")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeMedico,Especialidade")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
